...
BACKUP_PATH="/home/user/dev/vieshare_android/flutter/android/app/src/main/AndroidManifest.xml.backup"
BACKUP_HOME_PAGE_PATH="/home/user/dev/vieshare_android/flutter/lib/mobile/pages/home_page.dart.backup"
...
cp "$LIB_DIR/liblibvieshare.so" "./flutter/android/app/src/main/jniLibs/armeabi-v7a/libvieshare.so"
...
# mv build/app/outputs/apk/release/app-release.apk "$OUTPUT_DIR/$APK_NAME"

# mv "$MANIFEST_PATH.temp" "$MANIFEST_PATH"
# /home/user/dev/vieshare-android/flutter/build/app/outputs/bundle/release/app-release.aab
# Finished
# echo "Build complete. APK is located at $OUTPUT_DIR/$APK_NAME"
