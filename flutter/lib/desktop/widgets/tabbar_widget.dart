...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (vieShareWinManager.getActiveWindows().contains(kMainWindowId)) {
        await vieShareWinManager.unregisterActiveWindow(kMainWindowId);
      }
