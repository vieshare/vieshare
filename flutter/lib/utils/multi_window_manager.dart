...
class VieShareMultiWindowManager {
  VieShareMultiWindowManager._();

  static final instance = VieShareMultiWindowManager._();
  ...
  /// `vieShareWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final vieShareWinManager = VieShareMultiWindowManager.instance;
