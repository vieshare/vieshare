...
import '../widgets/lol_controls.dart';
  ...
  Widget getBodyForMobile() {
    ...
    return Container(
        ...
        child: Stack(children: () {
          ...
          // Add LoL controls overlay if enabled - using Obx for reactive updates
          paints.add(Obx(() {
            final lolOverlay = gFFI.gameControlsModel.buildLoLOverlay();
            return lolOverlay ?? SizedBox.shrink();
          }));
          return paints;
        }()));
  }
