      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep VieShare background service')),
        ...
        SettingsSection(
          ...
          tiles: [
            ...
            SettingsTile(
              ...
              onPressed: (context) =>
                  launchUrlString('https://vieshare.com/privacy.html'),
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('About VieShare')),
...
class ScanButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      // create fake QR code scanner
      onPressed: () {
        gFFI.dialogManager.show((setState, close, context) {
          return CustomAlertDialog(
            title: Text(translate('QR Code Scanner')),
            content: Text(translate('QR Code Scanner is not implemented yet.')),
            actions: [
