...
import 'package:flutter_hbb/models/game_controls_model.dart';
...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsVieShareVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsVieShareVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsVieShareVirtualDisplays);
        }
...
class FFI {
  ...
  late final GameControlsModel gameControlsModel; // session
  ...
  FFI(SessionID? sId) {
    ...
    gameControlsModel = GameControlsModel(WeakReference(this));
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get VieShareVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsVieShareVirtualDisplays] ?? []);
  ...
  bool get isVieShareIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'vieshare_idd';
