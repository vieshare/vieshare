...
pub const PORTABLE_APPNAME_RUNTIME_ENV_KEY: &str = "VIESHARE_APPNAME";
...
pub async fn do_check_software_update() -> hbb_common::ResultType<()> {
    let (request, url) =
        hbb_common::version_check_request(hbb_common::VER_TYPE_VIESHARE_CLIENT.to_string());
...
#[inline]
pub fn is_vieshare() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("VieShare")
}
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://admin.vieshare.com".to_owned()
}

#[inline]
pub fn is_public(url: &str) -> bool {
    url.contains("vieshare.com")
}
...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/VieShare.app/Contents/MacOS/VieShare", "XPC_SERVICE_NAME=com.carriez.VieShare_server"
...
pub type VieShareInterval = ThrottledInterval;

#[inline]
pub fn vieshare_interval(i: Interval) -> ThrottledInterval {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_VieShare_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = vieshare_interval(maker());
    ...
    #[allow(non_snake_case)]
    #[tokio::test]
    async fn test_VieShare_interval_sleep() {
        let base_intervals = [interval_maker, interval_at_maker];
