...
// stop_vieshare_servers() is just a temp solution here.
fn force_stop_server() {
    stop_vieshare_servers();
...
mod desktop {
    ...
    pub struct Desktop {
        ...
        pub xauth: String,
        pub home: String,
        pub is_vieshare_subprocess: bool,
    ...
    impl Desktop {
        ...
        pub fn is_headless(&self) -> bool {
            self.sid.is_empty() || self.is_vieshare_subprocess
        }
        ...
        fn set_is_subprocess(&mut self) {
            self.is_vieshare_subprocess = false;
            let cmd = format!(
            ...
            if let Ok(res) = run_cmds(&cmd) {
                if res.trim() != "0" {
                    self.is_vieshare_subprocess = true;
                }
            }
        }
...
pub fn uninstall_service(show_new_window: bool, _: bool) -> bool {
    ...
    // systemctl kill vieshare --tray, execute cp first
