...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete VieShare..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), VieShare potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare VieShare a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a VieShare il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a VieShare il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a VieShare di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [VieShare Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep VieShare background service", "Mantieni il servizio di VieShare in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione VieShare, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show VieShare", "Visualizza VieShare"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a VieShare 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a VieShare."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di VieShare."),
        ...
        ("verify_vieshare_password_tip", "Conferma password VieShare"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare VieShare e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_vieshare_server_pro_to_{}_tip", "Aggiorna VieShare Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di VieShare come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da VieShare"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra VieShare è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio Vieshare in background."),
        ...
        ("About VieShare", "Info su VieShare"),
        ...
        ("upgrade_remote_vieshare_client_to_{}_tip", "Aggiorna il client VieShare remoto alla versione {} o successiva!"),
