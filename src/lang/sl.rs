...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem VieShare..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, VieShare v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate VieShareu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate VieShareu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno VieShareu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »VieShare Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep VieShare background service", "Ohrani VieShareovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije VieShare, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "VieShare potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "VieShare potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_vieshare_password_tip", "Preveri geslo za VieShare"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite VieShare, prekinite klic in program zaprite."),
        ("scam_text2", "VieShare omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_vieshare_server_pro_to_{}_tip", "Prosimo, nadgradite VieShare Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo VieShare"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno VieSharea odprto"),
        ...
        ("floating_window_tip", "Pomaga pri VieShare storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_vieshare_client_to_{}_tip", "Prosimo, nadgradite VieShare odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
