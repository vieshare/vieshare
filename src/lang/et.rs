...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "VieSharei võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa VieShare mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et VieShare oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Click to download", "Vajuta allalaadimiseks"),
        ("Click to update", "Vajuta uuendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb VieShareile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb VieShareile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma VieShareile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [VieShare Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep VieShare background service", "Säilita VieSharei taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele VieSharei rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma VieShareile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma VieShareile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud VieSharei kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_vieshare_password_tip", "Kinnita VieSharei parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul VieSharei kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_vieshare_server_pro_to_{}_tip", "Palun täienda VieShare Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib VieShareil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb VieShareil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui VieSharei aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada VieSharei taustateenust."),
        ...
        ("About VieShare", "VieSharei teave"),
        ...
        ("upgrade_remote_vieshare_client_to_{}_tip", "Täiendage VieSharei klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
