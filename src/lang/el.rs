...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο VieShare..."),
        ...
        ("install_tip", "Λόγω UAC, το VieShare ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το VieShare στο σύστημα"),
        ("Click to upgrade", "Αναβάθμιση τώρα"),
        ("Click to download", "Λήψη τώρα"),
        ("Click to update", "Ενημέρωση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο VieShare."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα VieShare \"Screen Capture\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο VieShare να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος VieShare]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep VieShare background service", "Εκτέλεση του VieShare στο παρασκήνιο"),
        ...
        ("Show VieShare", "Εμφάνιση VieShare"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο VieShare"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το VieShare."),
        ...
        ("verify_vieshare_password_tip", "Επιβεβαιώστε τον κωδικό του VieShare"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το VieShare, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_vieshare_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον VieShare Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Έχετε ενεργοποιημένο το SELinux, το οποίο πιθανόν εμποδίζει την ορθή λειτουργία του VieShare."),
        ...
        ("powered_by_me", "Με την υποστήριξη της VieShare"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο VieShare είναι ανοιχτό"),
        ...
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας Vieshare"),
        ...
        ("About VieShare", "Πληροφορίες για το VieShare"),
        ...
        ("upgrade_remote_vieshare_client_to_{}_tip", "Αναβαθμίστε τον πελάτη VieShare στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
