...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till VieShare..."),
        ...
        ("install_tip", "På grund av UAC, kan inte VieShare fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera VieShare på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge VieShare \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge VieShare \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [VieShare Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep VieShare background service", "Behåll VieShare i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa VieShare programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
