...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "VieShare może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować VieShare w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić VieShare przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić VieShare na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [VieShare Input]."),
        ...
        ("Language", "Język"),
        ("Keep VieShare background service", "Zachowaj usługę VieShare w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji VieShare, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji VieShare uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z VieShare w Twojej sieci."),
        ...
        ("verify_vieshare_password_tip", "Weryfikuj hasło VieShare"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu VieShare - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_vieshare_server_pro_to_{}_tip", "Proszę zaktualizować VieShare Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu VieShare po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez VieShare"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno VieShare jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę VieShare w tle"),
        ...
        ("upgrade_remote_vieshare_client_to_{}_tip", "Proszę zaktualizować zdalny klient VieShare do wersji {} lub nowszej!"),
