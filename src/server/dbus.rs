...
///
/// Note:
/// On linux, we use dbus to communicate multiple vieshare process.
...
const DBUS_NAME: &str = "org.vieshare.vieshare";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "VieShare DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.vieshare.vieshare /dbus org.vieshare.vieshare.NewConnection string:'PEER_ID'`
