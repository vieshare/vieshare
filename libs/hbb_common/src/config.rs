...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("VieShare".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://vieshare.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://vieshare.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/rustdesk/rustdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("vieshare docs home", LINK_DOCS_HOME),
        ("vieshare docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("vieshare x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["64.23.133.199"];

lazy_static::lazy_static! {
    pub static ref RS_PUB_KEY: String = {
        std::env::var("RS_PUB_KEY").unwrap_or_else(|_| "your_public_key".to_owned())
    };
}
