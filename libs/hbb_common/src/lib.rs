...
pub const VER_TYPE_VIESHARE_CLIENT: &str = "vieshare-client";
pub const VER_TYPE_VIESHARE_SERVER: &str = "vieshare-server";

pub fn version_check_request(typ: String) -> (VersionCheckRequest, String) {
    const URL: &str = "https://api.vieshare.com/version/latest";
