...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("vieshare.com:21115"), "ws://vieshare.com/ws/id");
        assert_eq!(check_ws("vieshare.com:21116"), "ws://vieshare.com/ws/id");
        assert_eq!(check_ws("vieshare.com:21117"), "ws://vieshare.com/ws/relay");
        // set relay-server without port
        Config::set_option("relay-server".to_string(), "127.0.0.1".to_string());
        Config::set_option(
            "api-server".to_string(),
            "https://api.vieshare.com".to_string(),
        );
        assert_eq!(
        ...
        assert_eq!(check_ws("vieshare.com:21115"), "wss://vieshare.com/ws/id");
        assert_eq!(check_ws("vieshare.com:21116"), "wss://vieshare.com/ws/id");
        assert_eq!(
            check_ws("vieshare.com:21117"),
            "wss://vieshare.com/ws/relay"
        );
